...
class MainMenu(GameState):
    def __init__(self, master):
        ...
        world_buttons = ScrollableContainer(self, self.grid_cell_size, self.grid_cell_width * 15,
        ...
        if self.current_interface == "play":
            ...
            if keys[pygame.K_DOWN]:
                for widget in self.widgets:
                    if widget.text in self.world_names:
                        widget.translate([0, -5])
    ...
    def render(self, screen):
        # what is this line for??? just use screen.fill dumb ass
        pygame.draw.rect(screen, (0, 100, 150), self.master.screen_rect)
